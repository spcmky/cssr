...
use Cssr\MainBundle\Entity\Area;
use Cssr\MainBundle\Form\AreaType;
...
class AreaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CssrMainBundle:Area')->findAll();
     ...
     * @Method("POST")
     * @Template("CssrMainBundle:Area:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CssrMainBundle:Area')->find($id);
     ...
     * @Method("PUT")
     * @Template("CssrMainBundle:Area:edit.html.twig")
     */
